...
at its coordinating conjunction. The sentence you rewrote or merged during a
check is the one that crosses 25.
...
- **One idea per sentence.** Around 20 words in instructions, 25 in description.
  ...
  long. A draft sentence past 25 words gets split before sending, coordinated
  sentences included.
...
This rule tests the subject position, and the 25-word limit applies
separately. A sentence that grows by coordination (and, but, so, because)
keeps its subject at the front, and past 25 words it still gets split. A
seven-word sentence that opens on a dangling participle fails this rule.
